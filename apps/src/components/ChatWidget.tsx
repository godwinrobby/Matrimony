                      ...
                      <div className="flex items-center justify-end gap-1 mt-1.5">
                        ...
                        {isUser && (
                          <span className="inline-flex items-center">
                            {msg.status === 'read' ? (
                              <CheckCheck size={12} className="text-sky-200 stroke-[2.5]" title="Read" />
                            ) : msg.status === 'delivered' ? (
                              <CheckCheck size={12} className="text-orange-200" title="Delivered" />
                            ) : (
                              <Check size={12} className="text-orange-200" title="Sent" />
                            )}
                          </span>
                        )}
                      </div>
