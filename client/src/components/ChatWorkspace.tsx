                            ...
                            <div className="flex items-center justify-end gap-1 mt-1.5">
                              ...
                              {isUser && (
                                <span className="inline-flex items-center">
                                  {msg.status === 'read' ? (
                                    <CheckCheck size={13} className="text-sky-200 stroke-[2.5]" aria-label="Read" />
                                  ) : msg.status === 'delivered' ? (
                                    <CheckCheck size={13} className="text-orange-200" aria-label="Delivered" />
                                  ) : (
                                    <Check size={13} className="text-orange-200" aria-label="Sent" />
                                  )}
                                </span>
                              )}
                            </div>
